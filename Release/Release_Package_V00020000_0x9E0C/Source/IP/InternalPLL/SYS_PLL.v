...
/* Module Version: 5.7 */
/* C:\lscc\diamond\3.12\ispfpga\bin\nt64\scuba.exe -w -n SYS_PLL -lang verilog -synth synplify -arch xo3c00f -type pll -fin 19 -fclkop 38 -fclkop_tol 0.0 -fclkos 2 -fclkos_tol 0.0 -trimp 0 -phasep 0 -trimp_r -trims 0 -phases 0 -trims_r -phase_cntl STATIC -rst -fb_mode 1 -lock  */
/* Tue Feb 08 15:43:00 2022 */


`timescale 1 ns / 1 ps
module SYS_PLL (CLKI, RST, CLKOP, CLKOS, LOCK)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLKI;
    input wire RST;
    output wire CLKOP;
    output wire CLKOS;
    ...
    defparam PLLInst_0.CLKOS_CPHASE = 18 ;
    defparam PLLInst_0.CLKOP_FPHASE = 0 ;
    defparam PLLInst_0.CLKOP_CPHASE = 13 ;
    ...
    defparam PLLInst_0.CLKOS_DIV = 19 ;
    defparam PLLInst_0.CLKOP_DIV = 14 ;
    ...
    EHXPLLJ PLLInst_0 (.CLKI(CLKI), .CLKFB(CLKOP_t), .PHASESEL1(scuba_vlo), 
        ...
        .PLLDATO2(), .PLLDATO1(), .PLLDATO0())
             /* synthesis FREQUENCY_PIN_CLKOS="2.000000" */
             /* synthesis FREQUENCY_PIN_CLKOP="38.000000" */
    ...
    // exemplar begin
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOS 2.000000
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOP 38.000000
