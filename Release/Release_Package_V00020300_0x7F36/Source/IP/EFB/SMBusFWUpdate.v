...
/* Module Version: 1.2 */
/* C:\lscc\diamond\3.13\ispfpga\bin\nt64\scuba.exe -w -n SMBusFWUpdate -lang verilog -synth synplify -bus_exp 7 -bb -type efb -arch xo3c00f -freq 50 -i2c1config -i2c1_freq 400 -i2c1_sa 1000001 -i2c1_addr 7 -dev 2100  */
/* Fri May 24 15:59:59 2024 */


`timescale 1 ns / 1 ps
module SMBusFWUpdate (wb_clk_i, i2c1_scl, i2c1_sda, i2c1_irqo)/* synthesis NGD_DRC_MASK=1 */;
    input wire wb_clk_i;
