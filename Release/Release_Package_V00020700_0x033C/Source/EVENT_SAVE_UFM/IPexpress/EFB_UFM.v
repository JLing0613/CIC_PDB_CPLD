...
/* Module Version: 1.2 */
/* C:\lscc\diamond\3.13\ispfpga\bin\nt64\scuba.exe -w -n EFB_UFM -lang verilog -synth synplify -bus_exp 7 -bb -type efb -arch xo3c00f -freq 24.18 -i2c1 -i2c1_freq 100 -i2c1_sa 1000001 -i2c1_addr 7 -ufm -ufm_ebr 0 -mem_size 767 -ufm_0 -wb -dev 4300  */
/* Mon Oct 14 11:54:07 2024 */
...
module EFB_UFM (wb_clk_i, wb_rst_i, wb_cyc_i, wb_stb_i, wb_we_i, 
    ...
    inout wire i2c1_scl;
    inout wire i2c1_sda;
    output wire EFB_sda_o;
    output wire EFB_scl_o;
    ...
    wire i2c1_sdai;
    wire i2c1_scli;
	assign EFB_sda_o = i2c1_sdai;
	assign EFB_scl_o = i2c1_scli;
    ...
    defparam EFBInst_0.UFM_INIT_PAGES = 767 ;
    defparam EFBInst_0.DEV_DENSITY = "4300L" ;
